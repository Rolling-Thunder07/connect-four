...
function newGame(button) {
  ...
  class Slot {
    ...
    clicked() {
      ...
      el.style.backgroundColor = colorMap[nextColor];
      ...
      if (isWinner(this.column, this.row, nextColor, slotsArray) == true) gameOver(nextColor);
...
function setScore(winner) {
  ...
  document.getElementById(winner + "Score").innerHTML = parseInt(document.getElementById(winner + "Score").innerHTML) + 1;
}
